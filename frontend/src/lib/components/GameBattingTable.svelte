...
<thead class="bg-zinc-950/50">
  <tr class="border-b border-zinc-800 text-zinc-400 uppercase tracking-wider text-xs sm:text-sm font-medium">
    <th class="text-left py-3 px-4 w-[200px] sticky-column bg-[#111113]">Player</th>
...
<tbody>
  ...
  <tr class="border-b border-zinc-800/50 hover:bg-zinc-800/20">
    ...
    <td class="text-center py-2.5 px-2 text-zinc-300">{p.player_batting_hits ?? 0}</td>
    <td class="text-center py-2.5 px-2 text-zinc-300">{p.player_batting_doubles ?? 0}</td>
    <td class="text-center py-2.5 px-2 text-zinc-300">{p.player_batting_triples ?? 0}</td>
    <td class="text-center py-2.5 px-2 text-zinc-300">{p.player_batting_hr ?? 0}</td>
    ...
    <td class="text-center py-2.5 px-2 text-zinc-300">{p.player_batting_so ?? 0}</td>
  ...
  {#if bench.length > 0}
  <tr class="group">
    <td class="p-0 border-b border-zinc-800 sticky-column bg-zinc-900">
  ...
  {#if benchExpanded}
    ...
    <tr class="border-b border-zinc-800/30 bg-zinc-900/20">
      <td class="py-2 px-4 text-zinc-400 font-medium flex items-center gap-3 sticky-column bg-zinc-900">
