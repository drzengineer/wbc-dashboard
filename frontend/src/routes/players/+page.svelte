				...
				<thead class="text-xs text-[#8888a0] border-b border-border bg-surface-hover/50">
					{#if activeTab === 'Batting'}
						<tr>
							...
							<th class="text-left px-2 py-3 font-medium" style="min-width: 140px">Player</th>
							<th class="py-3 w-8"></th>
							<th class="px-2 py-3 font-medium text-center hidden sm:table-cell w-14">Team</th>
							<th class="px-2 py-3 font-medium text-center hidden md:table-cell w-10">
							...
							<th class="px-2 py-3 font-medium text-center hidden sm:table-cell w-10">
							...
							<th class="px-2 py-3 font-medium text-center hidden lg:table-cell w-14">
							...
							<th class="px-3 py-3 font-medium text-center hidden md:table-cell w-10">
					...
					{:else}
						<tr>
							...
							<th class="px-3 py-3 font-medium text-center hidden lg:table-cell w-10">
				...
				<tbody>
					{#each displayRows as row, i (row.person_id + '_' + row.season)}
						<tr class="border-b border-border/50 last:border-0 hover:bg-surface-hover/50 transition-colors">
							{#if activeTab === 'Batting'}
								<td class="px-4 py-2.5 text-[#555570] text-xs">{i + 1}</td>
								<td class="px-2 py-2.5">
									<a href="/players/{row.person_id}" class="font-medium text-white hover:text-accent transition-colors">{row.full_name}</a>
								</td>
							...
							<td class="px-2 py-2.5 text-center text-[#8888a0] hidden sm:table-cell">{row.team_abbreviation}</td>
								<td class="px-2 py-2.5 text-center tabular-nums {batSortKey === 'games_played' ? 'text-accent font-semibold' : 'text-[#8888a0]'} hidden md:table-cell">{fmtNum(row.games_played)}</td>
								<td class="px-2 py-2.5 text-center tabular-nums {batSortKey === 'season_batting_ab' ? 'text-accent font-semibold' : 'text-[#8888a0]'} hidden md:table-cell">{fmtNum(row.season_batting_ab)}</td>
								...
								<td class="px-2 py-2.5 text-center tabular-nums {batSortKey === 'season_batting_hr' ? 'text-accent font-semibold' : 'text-[#f0f0f5]'} hidden sm:table-cell">{fmtNum(row.season_batting_hr)}</td>
								<td class="px-2 py-2.5 text-center tabular-nums {batSortKey === 'season_batting_rbi' ? 'text-accent font-semibold' : 'text-[#f0f0f5]'} hidden sm:table-cell">{fmtNum(row.season_batting_rbi)}</td>
								<td class="px-2 py-2.5 text-center tabular-nums font-mono {batSortKey === 'season_batting_obp' ? 'text-accent font-semibold' : 'text-[#8888a0]'} hidden lg:table-cell">{fmtNum(row.season_batting_obp)}</td>
								<td class="px-2 py-2.5 text-center tabular-nums font-mono {batSortKey === 'season_batting_slg' ? 'text-accent font-semibold' : 'text-[#8888a0]'} hidden lg:table-cell">{fmtNum(row.season_batting_slg)}</td>
								...
								<td class="px-3 py-2.5 text-center tabular-nums {batSortKey === 'season_batting_sb' ? 'text-accent font-semibold' : 'text-[#8888a0]'} hidden md:table-cell">{fmtNum(row.season_batting_sb)}</td>
							{:else}
								<td class="px-4 py-2.5 text-[#555570] text-xs">{i + 1}</td>
								<td class="px-2 py-2.5">
									<a href="/players/{row.person_id}" class="font-medium text-white hover:text-accent transition-colors">{row.full_name}</a>
							...
							<td class="w-8 py-2.5 pr-1"><Flag country={row.team_abbreviation} size="sm" /></td>
							<td class="px-2 py-2.5 text-center text-[#8888a0] hidden sm:table-cell">{row.team_abbreviation}</td>
								<td class="px-2 py-2.5 text-center tabular-nums {pitSortKey === 'games_played' ? 'text-accent font-semibold' : 'text-[#8888a0]'} hidden md:table-cell">{fmtNum(row.games_played)}</td>
								...
								<td class="px-2 py-2.5 text-center tabular-nums {pitSortKey === 'season_pitching_so' ? 'text-accent font-semibold' : 'text-[#f0f0f5]'} hidden sm:table-cell">{fmtNum(row.season_pitching_so)}</td>
								<td class="px-2 py-2.5 text-center tabular-nums {pitSortKey === 'season_pitching_bb' ? 'text-accent font-semibold' : 'text-[#8888a0]'} hidden sm:table-cell">{fmtNum(row.season_pitching_bb)}</td>
								<td class="px-2 py-2.5 text-center tabular-nums {pitSortKey === 'season_pitching_w' ? 'text-accent font-semibold' : 'text-[#f0f0f5]'} hidden md:table-cell">{fmtNum(row.season_pitching_w)}</td>
								<td class="px-2 py-2.5 text-center tabular-nums {pitSortKey === 'season_pitching_l' ? 'text-accent font-semibold' : 'text-[#8888a0]'} hidden md:table-cell">{fmtNum(row.season_pitching_l)}</td>
								<td class="px-3 py-2.5 text-center tabular-nums {pitSortKey === 'season_pitching_sv' ? 'text-accent font-semibold' : 'text-[#8888a0]'} hidden lg:table-cell">{fmtNum(row.season_pitching_sv)}</td>
							{/if}
						</tr>
					{/each}
				</tbody>
